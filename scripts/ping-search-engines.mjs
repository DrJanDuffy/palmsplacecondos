...
const URLS = [
  ...
  `${ORIGIN}/guide/palms-place-strip-view-condos`,
  `${ORIGIN}/guide/palms-place-short-term-rentals`,
  `${ORIGIN}/guide/palms-place-unit-types`,
  `${ORIGIN}/guide/palms-place-hoa-and-monthly-costs`,
  `${ORIGIN}/guide/furnished-palms-place-condos`,
  `${ORIGIN}/guide/palms-place-amenities-and-resort-access`,
